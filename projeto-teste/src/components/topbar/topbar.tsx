...
export default function TopBar(){
    ...
    return(
<header className="fixed top-0 left-0 w-full bg-white p-4 flex justify-between items-center">
<div className="flex">
  ...
  <nav className="flex">
    <ul className="flex gap-1">
      <button  className="text-3xl hover:bg-[#F0F0F4] rounded px-1 py-1 mr-6"><HiMiniBars3/></button>
      <input 
      id="searchbutton"  
      type="text"  
      placeholder="Search" 
      className="bg-[#F0F0F4] rounded-3xl text-center px-25 h-9 mt-1 border border-gray-300 mr-165"
      /> 
      <NotificationButton/>
      <LanguageDropDown/>
